  ...
  return (
    <div className='row align-items-center px-4 mt-5 info20 py-3 mb-4'>
        <div className='col-xs-12 col-sm-12 col-md-4 col-lg-4 text-center'>
            ...
            <div className='fs-6 primario fw-bold font-arial txt-info20'>
              Años con la misma <br/> tasa de interés.
            </div>
        </div>
        <div className='col-xs-12 col-sm-12 col-md-8 col-lg-8 text-center pe-4 fs-4 primario txt-info20'>
